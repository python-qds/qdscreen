...
from .compat import SelectorMixin, BaseEstimator, NotFittedError, check_array
from .main import qdeterscreen
...
class QDSSelector(SelectorMixin, BaseEstimator):
    ...
    def fit(self, X, y=None):
        ...
        self.forest_ = qdeterscreen(X, absolute_eps=self.absolute_eps, relative_eps=self.relative_eps)
    ...
    def _get_support_mask(self):
        ...
        return self.forest_.roots_mask_ar
    ...
    def inverse_transform(self, X):
        ...
        self.forest_.predict_qd_features_from_roots(Xt, inplace=True)
        return Xt
